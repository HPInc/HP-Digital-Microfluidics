...
class DMFVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by DMFParser#return_stat.
    def visitReturn_stat(self, ctx:DMFParser.Return_statContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by DMFParser#ret.
    def visitRet(self, ctx:DMFParser.RetContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by DMFParser#sample_expr.
    def visitSample_expr(self, ctx:DMFParser.Sample_exprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by DMFParser#sample_type.
    def visitSample_type(self, ctx:DMFParser.Sample_typeContext):
        return self.visitChildren(ctx)
